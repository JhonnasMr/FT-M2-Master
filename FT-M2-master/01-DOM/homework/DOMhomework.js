...
let newCreador = document.querySelector('#createdBy');
newCreador.innerHTML += ' Ayrton Jhonnas Mr.';
...
function buildToDos(toDos) {
  // Tu código acá:
  let newArray = toDos.map(e => buildToDo(e, 0));
  return newArray;
}
...
function addToDo() {
  // Tu código acá:
  let valorImput = document.querySelector('#toDoInput').value;
  let myToDo = new ToDo(valorImput);
